...
| パターン | 呼び出し主体 | 典型用途 |
|---|---|---|
| **Trigger-first（分散）** | ゾーンごとの Trigger コンポーネントを Inspector で wire | Tutorial / 中小規模 / デザイナーが Inspector で組む |
...
## Trigger-first パターン（標準・Tutorial 採用）
...
- **小〜中規模 / デザイナー協業 / Tutorial 学習中** → Trigger-first
