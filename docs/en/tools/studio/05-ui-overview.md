...
| URL | Contents |
|---|---|
| `https://studio.hapbeat.com/en/` | Latest (always updated, English) |
| `https://studio.hapbeat.com/v0.2.0/` etc. | **Immutable snapshot** of each release (frozen, kept permanently) |
