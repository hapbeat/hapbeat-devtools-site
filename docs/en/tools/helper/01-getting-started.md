...
```
Browser (https://studio.hapbeat.com/en/)
...
Open <https://studio.hapbeat.com/en/> in your browser. If the Helper connection status at the top of Studio shows **green "Helper connected"**, the connection is working.
