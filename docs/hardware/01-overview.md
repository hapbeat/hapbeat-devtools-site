...
> Wi-Fi 接続やファーム書き込みの初期設定は [](/docs/tools/studio/initial-setup/) を参照してください。
...
| **Band WL** | 腕・脚・体幹など | 1 ch | 腕や足など特定の部位へのフィードバック |
...
OLED のレイアウトと送信側 address の対応は [](/docs/concepts/group-player-addressing/) に詳細があります。
...
➡️ [](/docs/tools/studio/initial-setup/)

## 関連リンク

- [](/docs/tools/studio/initial-setup/) — 入手後の Wi-Fi 設定とファーム書き込み手順
- [仕様と認証](./specifications/) — MCU / 通信 / バッテリー / 技適番号
- [運用ガイド](./care/) — 充電・お手入れ・取扱注意
- [トラブルを解決する](./troubleshooting/) — 起動しない / 振動が出ない時 / 既知問題
- [](/docs/concepts/architecture/) — Hapbeat と Studio / SDK の関係
