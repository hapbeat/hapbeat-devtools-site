...
> **推奨**: [Hapbeat Studio のオンボーディングウィザード](/docs/studio/initial-setup/)を使うと USB Serial 接続 → ファーム書き込み → Wi-Fi 設定を画面に沿って完了できます。以下のシリアルコマンド手順は上級者向けです。
...
- [Hapbeat 初期セットアップ](/docs/studio/initial-setup/)
