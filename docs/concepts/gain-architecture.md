...
- [Kit を作って配布する](/docs/tools/studio/kit-design/) — Studio での manifest intensity の決め方
- [EventMap ウィンドウ](/docs/sdk-integration/unity-sdk/event-map/) — EventMap gain の編集
- [Parameter Binding](/docs/sdk-integration/unity-sdk/parameter-binding/) — 動的 gain マッピング
