...
- [Studio Kit デザインガイド](/docs/tools/studio/kit-design/) — manifest intensity の決め方
- [Unity SDK EventMap](/docs/sdk-integration/unity-sdk/event-map/) — EventMap gain の編集
- [Unity SDK Parameter Binding](/docs/sdk-integration/unity-sdk/parameter-binding/) — 動的 gain マッピング
- [Fire vs Clip](./fire-vs-clip/)（予定）— mode による gain の扱いの違い
