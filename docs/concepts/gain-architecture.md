...
- [Studio Kit デザインガイド](/docs/studio/kit-design/) — manifest intensity の決め方
- [Unity SDK EventMap](/docs/unity-sdk/event-map/) — EventMap gain の編集
- [Unity SDK Parameter Binding](/docs/unity-sdk/parameter-binding/) — 動的 gain マッピング
