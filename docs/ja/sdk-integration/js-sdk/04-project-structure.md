...
- **呼び出し側で指定**: `hb.play("sample-kit.sine_100hz", { target: "player_1/chest" })`
...
hb.play("sample-kit.sine_100hz");  // command モード（デバイス上のクリップを再生）
...
hb.play("sample-kit.sine_100hz");  // command モード
