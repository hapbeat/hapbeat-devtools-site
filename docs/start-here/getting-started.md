...
OS 別の詳細手順やトラブルシューティングは **[hapbeat-helper インストールガイド](/docs/tools/helper/getting-started/)** を参照してください。
...
画面上部に **「Helper 接続中」** が緑で表示されることを確認してください。表示されない場合は Helper が起動していないか、ポート 7703 が塞がれています（[トラブルシューティング](/docs/tools/helper/getting-started/#トラブルシューティング)）。
...
- [FAQ / トラブルシューティング](/docs/support/faq/)
